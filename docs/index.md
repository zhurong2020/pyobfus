...
<div style="background: #f8f9fa; padding: 1.5em; border-radius: 8px; border-left: 4px solid #27ae60;">
  ...
  <ul style="color: #555; line-height: 1.8; margin-bottom: 0;">
    ...
    <li><strong>Reproducible Builds</strong> (v0.5.25): identical input and configuration produce identical output bytes, so a recipient can rebuild and check the digests in <code>--build-report</code>; randomised transforms (<code>--numeric-obfuscation</code>, string encryption) are excluded by design</li>
