...
<div style="background: #f8f9fa; padding: 1.5em; border-radius: 8px; border-left: 4px solid #27ae60;">
  ...
  <ul style="color: #555; line-height: 1.8; margin-bottom: 0;">
    ...
    <li><strong>Verifiable Build Report</strong> (next release): <code>--build-report</code> writes deterministic, privacy-safe JSON facts connecting selection/config, transformations, verification, output hashes, artifacts, markers, and provenance</li>
