...
- [ ] **Claude plugin — 联系 directory team 解锁后再重提**（2026-09-24 更正）：Console 重提被拒
      ...
      账号 `zhurong0525@gmail.com`。**2026-09-24 已在 Gmail 建好升级邮件草稿**(收件人
      `support@anthropic.com`,报错未提供专用联系入口),**待维护者审阅后发出**;发出后记回执/工单号。
      字段/描述文案仍见 `docs/internal/CLAUDE_PLUGIN_RESUBMISSION_2026-09-22.md`。
