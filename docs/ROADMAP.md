...
**Last Updated**: 2026-08-02 — pyobfus 0.5.5+0.5.6 released same day: P2-17
(`--provenance-manifest`) and P2-19 (`--preset ml`) flipped to shipped;
0.5.6 fixes issue #25 (CLI silently clobbered preset/config choices for
`preserve_param_names`/`remove_docstrings`/`remove_comments`) and sweeps 2
CodeQL alerts in the P2-18 benchmark sandbox. See `docs/POST_V0.4_TODO.md`
§ items 6-7 and `docs/DOC_SYNC_AUDIT_2026-08-02.md` for a broader
doc-staleness pass still in progress this session.
